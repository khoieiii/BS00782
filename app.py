...
# --- 2. Phân tích Dữ liệu với Biểu đồ ---
...
# Biểu đồ 2: Số lượng bán theo Location
...
# Biểu đồ 4: Top 5 sản phẩm có doanh thu cao nhất
...
# Pipeline tiền xử lý và mô hình
